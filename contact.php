...
<html lang="en">
  <head>
    ...
    <title>Nalini Teknologi Indonesia | Contact</title>
    <!-- web fonts -->
        ...
        <div class="cont-details col-md-5">
          ...
          <div class="cont-top">
            ...
            <div class="cont-right">
              <p><a href="tel:+62-895-3579-11-661">+62-895-3579-11-661</a></p>
          ...
          <div class="cont-top mt-4">
            ...
            <div class="cont-right">
              <p><a href="mailto:hello@nalinispace.my.id" class="mail">hello@nalinispace.my.id</a></p>
            </div>
          </div>
          <div class="cont-top mt-4">
            <div class="cont-left">
            ...
            <div class="cont-right">
              <p>Jl Gumuruh No 176A/117 Gatot Subroto, Bandung</p>
            </div>
          </div>
        </div>
